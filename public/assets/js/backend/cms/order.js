            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'archives.title', title: __('Archives_title'), operate: false, formatter: Table.api.formatter.content, class: 'autocontent'},
                        {field: 'title', title: __('Title'), formatter: Table.api.formatter.search, operate: 'like'},
                        {
                            field: 'archives.url', title: __('Url'), operate: false, formatter: function (value, row, index) {
