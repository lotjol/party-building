...
class Special extends Model
{
    ...
    public static function getSpecialList($params)
    {
        ...
        if ($paginate) {
            ...
            $list = $specialModel->limit($limit)->cache($cacheKey, $cacheExpire, 'cms')->select();
        }
    ...
    {
        $ids = Archives::whereRaw("FIND_IN_SET('{$special_id}', `special_ids`)")->cache(86400, null, 'cms')->column('id');
        return $ids;
    }
